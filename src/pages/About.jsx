    ...
    <div className="bg-gray-100">
      <div className="max-w-6xl mx-auto py-12 px-4 mt-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center md:mb-20">
          <div>
            ...
            <div className="space-y-4 text-gray-600">
              <p>
                FreshMart began with a simple idea: to create a grocery store
                that offers the freshest produce, highest quality meats, and
                finest selection of everyday essentials at fair prices.
              </p>
              <p>
              ...
              <p>
                We work directly with local farmers and producers to bring you
                the best products while supporting our local economy. Our team
                members are passionate about food and dedicated to providing
        ...
        <div className="mb-20 mt-10">
          <h2 className="text-3xl font-semibold mb-10 text-center text-green-600">
            Our Values
          </h2>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 ">
            {values.map((item, index) => {
              return (
                <div
                  key={index}
                  className="border-t-4 border-1 rounded-md border-green-500"
                >
                  <div className="py-6">
                    <div className="flex flex-col items-center text-center">
                      ...
                      <p className="text-gray-600 px-4">{item.para}</p>
                    </div>
                  </div>
                </div>
              );
